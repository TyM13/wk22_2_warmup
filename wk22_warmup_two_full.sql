...
INSERT INTO `pokemon` VALUES (1,'test','test','test');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `all_pokemon`()
begin
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_pokemon`(pokemon_name_input varchar(100), pokemon_description_input varchar(300), pokemon_image_url_input varchar(200))
    MODIFIES SQL DATA
begin
	insert into pokemon (name, description, image_url)
	values (pokemon_name_input, pokemon_description_input, pokemon_image_url_input);
...
-- Dump completed on 2022-10-13 16:27:16
